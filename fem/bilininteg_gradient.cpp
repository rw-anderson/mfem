...
{
   // TODO
   MFEM_VERIFY(false, "SHARED MEM NOT PROGRAMMED YET");
}
...
{
   // TODO
   MFEM_VERIFY(false, "Gradient PA Apply Transpose 2D NOT PROGRAMMED YET");
}
...
{
   // TODO
   MFEM_VERIFY(false, "Gradient PA Apply Transpose 3D NOT PROGRAMMED YET");
}
